...
`docs/assets/social-preview.png` is deterministic project artwork generated with
the `repo-release-excellence` hero generator from the design brief recorded in
[`docs/assets/README.md`](docs/assets/README.md). No stock asset was embedded.
