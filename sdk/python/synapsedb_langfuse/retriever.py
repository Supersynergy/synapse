"""
SynapseRetriever — wraps synapsedb search() and emits a Langfuse span per call.
...
class _Transport:
    ...
    def _recv_n(self, n: int) -> bytes:
        ...
        while len(buf) < n:
            ...
            if not chunk:
                raise ConnectionError("synapsedb-daemon closed connection")
            buf += chunk
        return buf
